...
FAQ_LIST = [
    {
        "keywords": ["dll", "maa", "dll was not found", "dll加载失败", "dll报错", "动态链接库", "初始化例程"],
        "question": "无法调用maa,提示缺少dll/动态链接库（DLL）初始化例程失效",
        "answer": "可以使用最新版下崽器替换更新dll，使用时确保Mower 已经后台关闭,或者按群文件替换攻略",
    },
    {
        "keywords": ["频道", "QQ", "联系方式", "群", "反馈"],
        "question": "我想要提出功能建议/遇到问题了需要寻求帮助",
        "answer": "加入QQ 频道 ArkMower（频道号：2r118jwue4）,需按群公告教程领取身份牌\n加入QQ群：521857729",
    },
    {
    ...
    {
        "keywords": ["支持", "重启", "自动启动", "设备", "adb devices", "目标", "模拟器"],
        "question": "提示“尚未支持重启/自动启动”，“未检测到相应设备，请前往‘adb devices’确认列表中列出了目标模拟器或设备”，无法启动模拟器。",
        "answer": "模拟器设置不正确，如使用“MUMU12”却设置为“其他”。",
    },
    {
        "keywords": ["多开", "模拟器", "连接", "多开管理器", "adb", "ADB"],
        "question": "mower怎么多开？",
        "answer": "1.打开目录下多开管理器.exe，点击[…]设置多开数据存储位置，设置完毕后点击[▶]\n2.设置ADB路径/ABD连接地址，具体连接地址可在模拟器多开器（MultiPlayer）中查看（MuMu多开器在shell文件夹里），多开编号在多开器中可见\nmaa多开可使用与单开一样的设置",
    },
    {
        "keywords": ["目录名称无效", "WinError 267"，"WinError 123"，"文件名"，"目录名"，"卷标语法"，"无效"，],
        "question": "“[WinError 267] 目录名称无效。”/“[WinError 123] 文件名、目录名或卷标语法无效。”",
        "answer": "模拟器文件夹未设置或设置有误，请认真阅读问号内的信息，修改该项设置后再试。",
    },
    {
        "keywords": ["重启", "退出"],
    ...
    },
    {
        "keywords": ["产能", "算法", "收益"],
        "question": "如何描述基建产能",
        "answer": "刷钱书时可用：订单*0.245+赤金*0.8+经验（CE6,LS6算法）；方便计算可订单*0.2+赤金*0.8+经验（82算法）。注意赤金由三部分组成：制造站生产，基建外获取（一般按5000算），贸易站龙舌兰节省。\n如果不刷钱书，基建产出不能以单一指标衡量，具体看mower的文档（链接），如使用其他算法可在 数据图表-基建报表 自定义算法系数",
    },
    {
    ...
    },
    {
        ...
        "question": "发送测试邮件失败，501,b'Bad address syntax。",
    ...
    },
    {
        ...
        "answer": "1.在数据图表-工休比报表中删除选定范围时间的心情。\n2.删除mower目录下，tmp文件夹中的data.db文件。\n3.若对数据库有所了解，可以用数据库管理软件（如开源的DBeaver）进行编辑。",
    },
    {
        "keywords": ["配置", "更新"],
    ...
    {
        "keywords": ["九色鹿", "自动合成"，"加工"，"自动加工"],
        "question": "怎么配置九色鹿自动合成材料？",
        "answer": "开启仓库物品混合读取。\n心情4以下材料和基建材料为九色鹿垫材，心情4材料为九色鹿暴击材料，为九色鹿设置垫材与暴击材料。\n九色鹿在心情回满时自动合成，当材料储量不满足设置时会发邮件提醒。\n建议合成路径为碳素，碳素组，家具零件_碳素组",
    },
    {
        "keywords": ["漏单", "跑单"],
        "question": "为什么会漏单？",
        "answer": "跑单刷新干员未写全/网络和配置问题/班表存在排班问题（如卡死或换班时间久）\n对应解决办法：补全跑单刷新干员/将跑单前置时间拉长或者使用葛朗台/优化或更换排班（如减少副表或者直接抄作业）",
    },
    {
        "keywords": ["找不到干员", "没有干员"],
        "question": "为什么我班表作业没有某个干员但是mower一直在找该干员？我应该怎么检查？",
        "answer": "方法一：检查作业的副表，尤其是检查副表任务\n方法二：将作业导出成json格式，用记事本或VSC等工具打开作业，查找（Ctrl+f）对应干员（抄作业缺少某个干员也可以这样一键替换）",
    },
]
